...
VERIFY2_URL = environ.get('VERIFY2_URL', "urlshorten.in")
VERIFY2_API = environ.get('VERIFY2_API', "b3700b5b6416fdae3880a206f30d6dee7b92b883")
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'urlshorten.in')
SHORTLINK_API = environ.get('SHORTLINK_API', 'b3700b5b6416fdae3880a206f30d6dee7b92b883')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', True))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+txFGyjBwD_g3MTZl')
